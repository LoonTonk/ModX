 ...
 * particular, you can set here the values of variables elements defined in modx_modx.tpl (elements
...
class view_modx_modx extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "modx_modx", "myblock" );
