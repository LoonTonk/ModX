    ...
    var ModX = (function (_super) {
        ...
        ModX.prototype.setup = function (gamedatas) {
            ...
            for (var player_id in gamedatas.players) {
                ...
                var teamNum = gamedatas.playerTeams[parseInt(player_id)];
                ...
                if (teamNum !== '0') {
                    var team_icon_tt = dojo.string.substitute(_("You are on team ${team}"), { team: teamNum });
                    this.addTooltip("team_icon_".concat(player_id), team_icon_tt, '');
                }
        ...
        ModX.prototype.onLeavingState = function (stateName) {
            switch (stateName) {
                case 'wildPlacement':
        ...
        ModX.prototype.addTokenOutline = function (x, y) {
        ...
        ModX.prototype.markSelectableToken = function (x, y) {
            var selectable_token = $("token_".concat(x, "_").concat(y));
        ...
        ModX.prototype.addTokenOnBoard = function (x, y, player_id, selectable) {
            var _a;
        ...
        ModX.prototype.addTileOnBoard = function (x, y, player_id) {
            ...
            dojo.connect(animation_id, 'onEnd', function () {
                ...
                if (curr_scoretile === null) {
                    throw new Error("trying to access scoretile by id gave null");
                }
                curr_scoretile.style.left = '0px';
                curr_scoretile.style.top = '0px';
            });
            animation_id.play();
        };
        ...
        ModX.prototype.isWild = function (id) {
            return (id >= 1 && id <= ModX.MAX_WILDS);
        };
        ModX.prototype.onsquareClick = function (evt) {
            evt.preventDefault();
        ...
        ModX.prototype.onselectToken = function (evt) {
            evt.preventDefault();
            if (!(evt.currentTarget instanceof HTMLElement))
                throw new Error('evt.currentTarget is null! Make sure that this function is being connected to a DOM HTMLElement.');
            if (this.checkAction('placeToken', true)) {
        ...
        ModX.prototype.onfinishTurn = function (evt) {
            evt.preventDefault();
            if (!(evt.currentTarget instanceof HTMLElement))
                throw new Error('evt.currentTarget is null! Make sure that this function is being connected to a DOM HTMLElement.');
        ...
        ModX.prototype.notif_moveWild = function (notif) {
        ...
        ModX.prototype.notif_removeTokens = function (notif) {
            var _this = this;
        ...
        ModX.prototype.notif_markSelectableTokens = function (notif) {
            var _this = this;
            notif.args.forEach(function (token_pos) {
                _this.markSelectableToken(token_pos.x, token_pos.y);
            });
        };
        ModX.prototype.notif_scorePattern = function (notif) {
        ...
        ModX.prototype.notif_instantWin = function () {
            ...
            playSound('modx_instant_win_sound');
        };
        ModX.MAX_WILDS = 5;
        return ModX;
    }(Gamegui));
    dojo.setObject("bgagame.modx", ModX);
});
